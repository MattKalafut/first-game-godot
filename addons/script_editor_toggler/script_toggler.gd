...
# This plugin was created by audiBookning on Github (https://github.com/audiBookning) and can be found at the link below:
# https://github.com/godotengine/godot-proposals/issues/3659#issuecomment-1766638481
